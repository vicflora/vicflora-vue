...
@import "./bioregions.scss";
</style>

<template>
  <div class="m-bioregions">
    <b-container>
      <b-row class="mb-2">
        ...
        <b-col md="8" class="text-left">
          <figure>
            <div class="m-map-container">
              ...
              />
              <BioregionsMapConfig></BioregionsMapConfig>
            </div>
          </figure>
        </b-col>
        <b-col class="text-left">
          <div class="m-legend-item">
            ...
            ></span>
            <span class="m-legend-label">Snowy Mountains</span>
          </div>
          <div class="m-legend-item">
            <span
              class="m-legend-symbol"
          ...
          <div class="m-legend-item">
            ...
            ></span>
            <span class="m-legend-label">Flinders</span>
          </div>
          <div class="m-legend-item">
            <span
              class="m-legend-symbol"
