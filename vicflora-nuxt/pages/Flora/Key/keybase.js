...
;(function( $ ) {
    ...
    $.prototype.keybase = function() {
        ...
        settings = $.extend(true, {}, $.prototype.keybase.defaults, settings, options);
        ...
        if (settings.filterItems.length > 0) {
            ...
            if (settings.filterItemNames.length > 0) {
                filter_items = JSPath.apply('.items{.item_name===$item_name}.item_id', $.prototype.keybase.getters.jsonKey(), {item_name: settings.filterItemNames});
            }
            else {
    ...
    $.prototype.keybase.defaults.playerWindow = function() {
        ...
        // Resize Player panes
        var position;
        $('.keybase-player-window').on('mousedown', '.keybase-player-drag-leftright', $.prototype.keybase.dragLeftRight);
        $('.keybase-player-leftpane').on('mousedown', '.keybase-player-drag-updown', $.prototype.keybase.dragUpDownLeftPane);
        $('.keybase-player-rightpane').on('mousedown', '.keybase-player-drag-updown', $.prototype.keybase.dragUpDownRightPane);
     ...
     */
    $.prototype.keybase.defaults.currentNodeDisplay = function(node, currentNodeDiv) {
        var leads = [];
     ...
     * @param itemsDiv
     */
    $.prototype.keybase.defaults.remainingItemsDisplay = function(items, itemsDiv) {
     ...
     * @param itemsDiv
     */
    $.prototype.keybase.defaults.discardedItemsDisplay = function(items, itemsDiv) {
        var list = itemsDisplay(items);
    ...
    var nextCouplet = function() {
        ...
        $.prototype.keybase.getters.remainingItems = function() { return items.remaining; };
        $.prototype.keybase.getters.discardedItems = function() { return items.discarded; };
    ...
    var getPath = function() {
        ...
        $.prototype.keybase.getters.path = function() {return path;};
        return path;
    };
